...
export const menuItems = [
  ...
  { id: 5, href: "https://blog.cndlogistic.co.id/", label: "Blog", external: true },
...
export const featurePageLinks = [
  {
    ...
    icon: "unicon-cube",
    items: [
      { icon: "icon-01.svg", title: "Freight Forwarder", description: "Layanan pengurusan transportasi barang end-to-end" },
  ...
  },
  {
    ...
    items: [
      { icon: "icon-04.svg", title: "Ekspedisi", description: "Pengiriman reguler & express ke seluruh Indonesia" },
