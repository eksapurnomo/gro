...
export default function Pricing({ data }) {
  ...
  const badge = data?.badge || "Pricing";
  const title = data?.title || "Simple, scalable pricing.";
  const description = data?.description || "No extra charges. No hidden fees.";
                      ...
                      >
                        ...
                        <header className="tier-header vstack gap-2 items-center">
                          ...
                          <Link
                            ...
                            href={`/sign-up`}
                          >
                            <span>{plan.linkText || "Pilih Layanan"}</span>
                          </Link>
                          {plan.details && <p className="details">{plan.details}</p>}
                        </header>
