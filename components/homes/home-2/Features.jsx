          ...
          <div className="section-inner panel">
            ...
            >
              ...
              <p className="fs-6 xl:fs-5 text-dark dark:text-white text-opacity-70">
                Solusi logistik profesional dengan jangkauan nasional, layanan cepat, dan dukungan pelanggan yang selalu siap membantu.
              </p>
            </div>
            <div className="row child-cols-12 sm:child-cols-6 xl:child-cols-4 col-match justify-center g-2 lg:g-4">
              {features.map((feature, index) => (
                <div key={index}>
                  <div
                    className="feature-item panel px-3 lg:px-4 py-4 rounded-2 bg-secondary dark:bg-gray-900"
